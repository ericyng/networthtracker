...
class Command(BaseCommand):
    help = 'Test the new dashboard category data structure'

    def handle(self, *args, **options):
        # Get the current month and year
        current_date = timezone.now()
        
        self.stdout.write(f'Testing dashboard category data for current month ({current_date.month}/{current_date.year}):\n')
        ...
        self.stdout.write('Sample chart data point:')
